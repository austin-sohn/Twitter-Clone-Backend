...
# verifies authentication for creating post, request "users/login/{username}" endpoint
@hug.cli()
...
@hug.get("/home/{username}", requires=auth)
...
# checks health of timelines
@hug.get("/timelines/health", status=hug.falcon.HTTP_200)
